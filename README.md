...
The final Gradient Boosting model with r2_score : 0.51 was applied on the unseen movies to determine their ratings. The model performance was very close to train dataset with r2_score: 0.51.
